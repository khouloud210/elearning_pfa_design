...
class _ProfileState extends State<Profile> {
  ...
  TextEditingController txtTelController = TextEditingController();
  TextEditingController txtJSController = TextEditingController();
  TextEditingController txtJVController = TextEditingController();
  ...
  void getUser() async {
    ...
    if (response.error == null) {
      setState(() {
        ...
        txtAdresseController.text = user!.adresse ?? '';
        txtTelController.text = user!.tel ?? '';
        ...
        : Padding(
            ...
            child: ListView(
              children: [
                ...
                TextFormField(
                  decoration: kInputDecoration('Adresse'),
                ...
                TextFormField(
                  decoration: kInputDecoration('Tel'),
                  controller: txtTelController,
                  validator: (val) => val!.isEmpty ? 'Invalid Tel' : null,
                ),
                SizedBox(
                  height: 20,
                ),
