...
import 'package:e_learning_app/login_lib/models/comment.dart';
import 'package:e_learning_app/login_lib/services/comment_service.dart';
                                      ...
                                      Row(
                                        children: [
                                          Container(
                                            ...
                                            height: 30,
                                            decoration: BoxDecoration(
                                                image: comment.user!.adresse !=
                                                        null
                                                    ? DecorationImage(
                                                        image: NetworkImage(
                                                            '${comment.user!.adresse}'),
                                                        fit: BoxFit.cover)
                                                    : null,
                                                borderRadius:
