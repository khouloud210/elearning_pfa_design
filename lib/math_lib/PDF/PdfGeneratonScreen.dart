// ignore_for_file: file_names, library_private_types_in_public_api, unsafe_html, noop_primitive_operations, duplicate_ignore, use_build_context_synchronously
...
class PdfGenerationScreen extends StatefulWidget {
  const PdfGenerationScreen({Key? key, 
    required this.icon,
